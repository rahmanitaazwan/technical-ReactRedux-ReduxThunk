...
import { ADD_TO_CART, REMOVE_ITEM, SUB_QUANTITY, ADD_QUANTITY, ADD_SHIPPING, SUB_SHIPPING, CHECK_SHIPPING, UNCHECK_SHIPPING } from '../actions/action-types/cartActions'}
...
const cartReducer = (state = initState, action) => {
  ...
  if (action.type === UNCHECK_SHIPPING) {
    return {
      ...state,
      shippingChecked: false
    };
